...
namespace MyMIS
{
    public partial class SCSGD1 : UserControl
    {
        #region 定量
        ...
        private void SCSGD1_Load(object sender, EventArgs e)
        {
        ...
        private void toolStripButton2_Click_1(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = ExecuteStoredPro("produce4", id, starttime, endtime);
        ...
        public static DataTable ExecuteStoredPro(string storeName, string ID, DateTime STARTDATE, DateTime ENDDATE)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    SqlParameter[] para ={
                                     new SqlParameter("@DHS",SqlDbType.VarChar),
