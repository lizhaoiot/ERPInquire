...
namespace Tools.Common
{
    ...
    public class SQLiteHelper
    {
        ...
        /// <returns></returns>
        public static bool ExecuteNonQuery(string commandText, params object[] paramList)
        {
        ...
        private static SQLiteParameterCollection AttachParameters(SQLiteCommand cmd, string commandText, params object[] paramList)
        {
            ...
            foreach (object o in paramList)
            {
                ...
                switch (t.ToString())
                {
                    ...
                    case ("System.Data.SQLite.SQLiteParameter"):
                        parm.DbType = DbType.String;
                        parm.ParameterName = paramNames[j];
                        System.Data.SQLite.SQLiteParameter s = new System.Data.SQLite.SQLiteParameter();
                        s = (System.Data.SQLite.SQLiteParameter)paramList[j];
                        parm.Value = s.Value;
                        coll.Add(parm);
                        break;
